                ...
                <div class="card-body">
                    ...
                    <div class="row">       {{--start row--}}
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" value="{{ old('mobile_number',$getRecord->mobile_number) }}" name="mobile_number" placeholder="Mobile Number">
...
{{--showing profile pic--}}   <img src="{{ $getRecord->getProfile() }}" style="width:auto; height:50px;">
